...
<section class="top-page">
  ...
  <div class="search-bar-frontpage">
    <form class="search-bar-1" action="<?php echo SITEURL; ?>search.php" method="POST">
      ...
      <input id="search" type="search" placeholder="Search for Food..." autofocus name="search" required />
      <!-- SEARCH BUTTON -->
...
<section class="contact" id="contact">
  ...
  <div class="contact-info-upper-container">
    <div class="contact-info-container">
      <img src="./css/images/email.png" alt="email icon" class="icon contact-icon mail-icon" />
      <p>
        <a href="mailto:snackpack@gmail.com">snackpack@gmail.com</a>
      </p>
    </div>
    <div class="contact-info-container">
      <img src="./css/images/phone.png" alt="phone icon" class="icon contact-icon phone-icon" />
      <p>+977-9828932151</p>
    </div>
    <div class="contact-info-container">
      <img src="./css/images/facebook.png" alt="facebook icon" class="icon contact-icon" />
      <p>
        <a href="https://www.facebook.com" target="_blank">Facebook</a>
      </p>
    </div>
    <div class="contact-info-container">
      <img src="./css/images/instagram.png" alt="instagram icon" class="icon contact-icon" />
      <p>
        <a href="https://www.instagram.com" target="_blank">Instagram</a>
      </p>
    </div>
    <div class="contact-info-container">
      <img src="./css/images/linkedin.png" alt="linkendin icon" class="icon contact-icon" />
      <p>
