...
<div style="background-color:#74b659; padding: 20px; overflow-x: auto;">
    ...
    <table style="width: 100%; background-color: white; border: 1px solid black; border-collapse: collapse; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <tbody>
        ...
        ?>
                    <tr>
                        <td style="border: 1px solid #000; padding: 10px;"><?php echo $date; ?></td>
                        ...
                        <td style="border: 1px solid #000; padding: 10px;">Rs. <?php echo $amount; ?></td>
        ...
        ?>
                <tr>
                    <td colspan="7" style="text-align: center; padding: 10px;">No orders found.</td>
                </tr>
        <?php
            }
        }
